...
import {changeContentBackground} from 'src/pages/tiny/RomListBar.vue'

const global = useGlobalStore();
const {
  activePlatform, activeRom, activeMenu, activeFocus, menuLike, activePlatformDesc,
  activeLetter, platformUi, rombaseAlias, config, lang,
} = storeToRefs(global);
...
function changePlatformUi(id: number) {
  ...
  //读取平台ui
  GetPlatformUi(id, "Tiny").then((result: string) => {
    let resp = decodeApiData(result)
...
<style scoped>
@import "src/css/tiny/platform.css";
